...
const ProductItem = (props) => {
  ...
  console.log("props?.item?.images[0] : ", props?.item)
      ...
      <div className="group imgWrapper w-[100%]  overflow-hidden  rounded-md rounded-bl-none rounded-br-none relative">
        <Link to={`/product/${props?.item?._id}`}>
          <div className="img h-[200px] overflow-hidden">
            <img
              src={`https://serviceapi.spicezgold.com/download/${props?.item?.images[0]}`}
              className="w-full"
            />

            {
              ...
              <img
                src={`https://serviceapi.spicezgold.com/download/${props?.item?.images[1]}`}
